...
class TestGetUtxos(unittest.TestCase):
    ...
    def test_get_utxos(self):
        utxos = self.test_client.get(
            "/crypto/wallet/utxos?address=tb1qsajy7ag7xs47vqltlr939gtm28dx2kdthlt262"
        )
        self.assertEqual(
            utxos.json,
            {
                ...
                "utxos": [
                    {
                        ...
                        "status": {
                            "confirmed": True,
                            "block_height": 2287015,
                            "block_hash": "000000000000002f6e40da79151c2bd0c678465f0f2a57267610d24046139fdd",
                            "block_time": 1658365882,
                        },
                        "value": 10000,
                    }
                ],
