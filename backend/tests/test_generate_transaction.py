...
class TestGenerateTransaction(unittest.TestCase):
    ...
    def test_generate_unsigned_transaction(self):
        res = self.test_client.post(
            ...
            json={
                ...
                "outputs": [
                    {
                        "address": "n1XMyLcoCGpzvtcQ4UVWdUBXSXZGjEvUS4",
                        "value": 0.000005,
                    },
                    {
                        "address": "mnFMstk4ZejC5W21r6tG3uLMFTkT3CtG2F",
                        "value": 0.0000045,
                    },
                ],
            },
    ...
    def test_generate_bad_output(self):
        res = self.test_client.post(
            ...
            json={
                ...
                "outputs": [{"address": "tb1qsajy7ag7xs47vqltlr939gtm28dx2kdthlt262"}],
            },
        )
        self.assertEqual(res.status_code, 400)
    ...
    def test_generate_insufficient_balance(self):
        ...
        self.assertEqual(
            res.json["error"],
            "You are trying to create a transaction that will output more than the UTXOs inputted.",
        )
